...
RED.sidebar = (function() {
    ...
    function updateToggleButtonIcon(sidebar, isOpen) {
        if (sidebar.toggleButton) {
            const icon = sidebar.toggleButton.find('i');
            icon.removeClass('fa-caret-square-o-left fa-caret-square-o-right');
            if (isOpen) {
                icon.addClass(sidebar.direction === 'right' ? 'fa-caret-square-o-right' : 'fa-caret-square-o-left');
            } else {
                icon.addClass(sidebar.direction === 'right' ? 'fa-caret-square-o-left' : 'fa-caret-square-o-right');
            }
        }
    }
    ...
    function setupSidebarTabs() {
        ...
        const leftToggleButton = $('<button class="red-ui-sidebar-toggle-button"><i class="fa fa-caret-square-o-left"></i></button>')
        ...
        leftToggleButton.appendTo(tabBar);
        sidebars.secondary.toggleButton = leftToggleButton;

        const rightToggleButton = $('<button class="red-ui-sidebar-toggle-button"><i class="fa fa-caret-square-o-right"></i></button>')
        ...
        rightToggleButton.appendTo(tabBar);
