...
RED.search = (function() {
    ...
    function createDialog() {
        ...
        var copySearchContainer = $('<button type="button" class="red-ui-button red-ui-button-small"><i class="fa fa-caret-right"></button>').attr('aria-label', RED._('search.showInOutline')).appendTo(searchDiv).on('click', function(evt) {
            evt.preventDefault();
        ...
        searchResults = $('<ol>',{style:"position: absolute;top: 5px;bottom: 5px;left: 5px;right: 5px;"}).appendTo(searchResultsDiv).editableList({
            ...
            addItem: function(container,i,object) {
                ...
                if (object.historyHeader) {
                    ...
                    $('<button type="button" class="red-ui-button red-ui-button-small"><i class="fa fa-remove"></i></button>').attr('aria-label', RED._('common.label.delete')).appendTo(container).on("click", function(evt) {
                        evt.preventDefault();
