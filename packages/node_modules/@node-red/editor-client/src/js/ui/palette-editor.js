...
RED.palette.editor = (function() {
        ...
        if (!nodeEntries.hasOwnProperty(module)) {
            ...
            if (!moduleInfo.url) {
                if (loadedIndex[module] && loadedIndex[module].url) {
                    ...
                    $('<a target="_blank" class="red-ui-palette-module-link"><i class="fa fa-external-link"></i></a>').attr({ href: moduleInfo.url, 'aria-label': RED._('palette.editor.moduleDocumentation') }).appendTo(titleRow);
                }
            }
            ...
            addItem: function(container,i,object) {
                ...
                if (entry) {
                    ...
                    if (entry.url) {
                        ...
                        $('<a target="_blank" class="red-ui-palette-module-link"><i class="fa fa-external-link"></i></a>').attr({ href: entry.url, 'aria-label': RED._('palette.editor.moduleDocumentation') }).appendTo(titleRow);
                    }
                    ...
                    var shade = $('<div class="red-ui-palette-module-shade hide"><img src="red/images/spin.svg" alt="" class="red-ui-palette-spinner"/></div>').appendTo(container);
    ...
    function createInstallTab(content) {
        ...
        $('<div id="red-ui-palette-module-install-shade" class="red-ui-palette-module-shade hide"><div class="red-ui-palette-module-shade-status"></div><img src="red/images/spin.svg" alt="" class="red-ui-palette-spinner"/></div>').appendTo(installTab);
    }
    ...
    function autoInstallModules(modules) {
        ...
        const installModule = function (module) {
            ...
            const spinner = '<div style="text-align: center; height: 100%; padding-top: 20px;"><img src="red/images/spin.svg" alt="" style="width: 60px;"/></div>';
