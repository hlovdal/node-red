...
RED.projects = (function() {
                    ...
                    content: function(options) {
                        ...
                        projectNameInput.on("change keyup paste",function() {
                            ...
                            if (checkProjectName) {
                                ...
                                projectNameStatus.empty();
                                $('<img src="red/images/spin.svg" alt=""/>').appendTo(projectNameStatus);
    ...
    function addSpinnerOverlay(container) {
        var spinner = $('<div class="red-ui-component-spinner"><img src="red/images/spin.svg" alt=""/></div>').appendTo(container);
        return spinner;
    }

    function init() {
        dialog = $('<div id="red-ui-projects-dialog" class="hide red-ui-projects-edit-form"><div class="red-ui-projects-dialog-box"><form class="form-horizontal"></form><div class="red-ui-component-spinner hide"><img src="red/images/spin.svg" alt=""/></div></div></div>')
