        ...
        var trayOptions = {
            ...
            open: function(tray, done) {
                ...
                $('<input id="node-input-node-disabled" type="checkbox">').prop("checked",!!node.d).appendTo(trayFooterLeft).toggleButton({
                    enabledLabel: RED._("workspace.disabled"),
                    enabledIcon: "fa-ban",
                    disabledLabel: RED._("workspace.enabled"),
        ...
        var trayOptions = {
            ...
            open: function(tray, done) {
                ...
                $('<input id="node-input-locked" type="checkbox">').prop("checked",workspace.locked).appendTo(trayFooterRight).toggleButton({
                    enabledLabel: RED._("common.label.locked"),
                    enabledIcon: "fa-lock",
                    disabledLabel: RED._("common.label.unlocked"),
                    disabledIcon: "fa-unlock-alt",
                })
