...
RED.palette = (function() {
        ...
        try {
            ...
            if (typeInfo) {
                ...
                if (/^subflow:/.test(type)) {
                    $('<button type="button" onclick="RED.workspaces.show(\''+type.substring(8).replace(/'/g,"\\'")+'\'); return false;" class="red-ui-button red-ui-button-small" style="float: right; margin-left: 5px;" aria-label="'+RED._('subflow.editSubflowProperties')+'"><i class="fa fa-pencil"></i></button>').appendTo(popOverContent)
                }

                $('<button type="button" onclick="RED.search.show(\'type:'+searchType+'\'); return false;" class="red-ui-button red-ui-button-small" style="float: right; margin-left: 5px;" aria-label="'+RED._('palette.searchByType')+'"><i class="fa fa-search"></i></button>').appendTo(popOverContent)

                $('<button type="button" onclick="RED.sidebar.help.show(\''+safeType+'\'); return false;" class="red-ui-button red-ui-button-small" style="float: right; margin-left: 5px;" aria-label="'+RED._('sidebar.help.showHelp')+'"><i class="fa fa-book"></i></button>').appendTo(popOverContent)
    ...
    function init() {
        ...
        $('<img src="red/images/spin.svg" alt="" class="red-ui-palette-spinner hide"/>').appendTo("#red-ui-palette");
