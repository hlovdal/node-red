...
RED.tabs = (function() {
    ...
    function createTabs(options) {
        ...
        if (options.scrollable) {
            ...
            scrollLeft.attr('aria-label', RED._('common.tabs.scrollLeft'));
            ...
            scrollRight.attr('aria-label', RED._('common.tabs.scrollRight'));
        ...
        if (options.menu) {
            ...
            var menuButtonLink = menuButton.find('a').attr('aria-label', RED._('common.tabs.menu'))
            var menuOpen = false;
            var menu;
        ...
        if (options.collapsible) {
            ...
            if (options.menu !== false) {
                var selectButton = $('<a href="#"><i class="fa fa-caret-down"></i></a>').attr('aria-label', RED._('common.tabs.selectTab')).appendTo(collapsedButtonsRow);
