    ...
    var allOptions = {
        ...
        cred: {
            ...
            valueLabel: function (container, value) {
                ...
                var eyeButton = $('<button type="button" class="red-ui-button red-ui-button-small"></button>').attr('aria-label', RED._('typedInput.passwordToggle')).css({
                    width: "20px"
                ...
                if (value === "__PWRD__") {
                    ...
                    var editButton = $('<button type="button" class="red-ui-button red-ui-button-small"><i class="fa fa-pencil"></i></button>').attr('aria-label', RED._('typedInput.editPassword')).appendTo(buttons).on("click", function (evt) {
                        evt.preventDefault();
                        innerContainer.hide();
                    ...
                    var cancelButton = $('<button type="button" class="red-ui-button red-ui-button-small"><i class="fa fa-times"></i></button>').attr('aria-label', RED._('common.label.cancel')).css("margin-left", "3px").appendTo(buttons).on("click", function (evt) {
                        evt.preventDefault();
                        innerContainer.show();
                ...
                if (!opt.multiple) {
                    if (o.icon) {
                        if (o.icon.indexOf("<") === 0) {
                            ...
                            // url
                            $('<img>',{src:mapDeprecatedIcon(o.icon), alt:"", style:"height: 18px;"}).prependTo(this.optionSelectLabel);
                        } else {
                            // icon class
