...
RED.userSettings = (function() {
    ...
    function applyThemeClass(val) {
        // Don't interfere with custom theme plugins
        // This is a temporary measure until we standardize a way for themes to indicate if they
        // provide their own light/dark variants.
        ...
        if (val === 'dark') {
            ...
            _darkMediaListener = function(e) {
                document.documentElement.classList.toggle('nr-theme-dark', e.matches);
                if (window.monaco) {
                    monaco.editor.setTheme(e.matches ? 'vs-dark' : 'vs');
                }
                if (RED.editor.mermaid) {
                    RED.editor.mermaid.setTheme(e.matches);
                }
            };
