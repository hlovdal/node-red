RED.tourGuide = (function() {
    ...
    function runTourStep(step, state, done) {
        ...
        prepareStep(step, state, function() {
            ...
            $('<button type="button" class="red-ui-button red-ui-button-small" style="float: right; margin-top: -4px; margin-right: -4px;"><i class="fa fa-times"></i></button>').attr('aria-label', RED._('common.label.close')).appendTo(stepContent).click(function(evt) {
                evt.preventDefault();
            ...
            if (step.image) {
                $('<img>').attr({ src: `red/tours/${step.image}`, alt: getLocaleText(step.title) || "" }).appendTo(stepDescription)
            }
