...
RED.subflow = (function() {
    ...
    function showWorkspaceToolbar(activeSubflow) {
        ...
        $('<span style="margin-left: 5px;" data-i18n="subflow.output"></span> <div id="red-ui-subflow-output" style="display: inline-block;" class="button-group spinner-group">'+
            '<a id="red-ui-subflow-output-remove" class="button" href="#" aria-label="'+RED._('subflow.removeOutput')+'"><i class="fa fa-minus"></i></a>'+
            '<div class="spinner-value">3</div>'+
            '<a id="red-ui-subflow-output-add" class="button" href="#" aria-label="'+RED._('subflow.addOutput')+'"><i class="fa fa-plus"></i></a>'+
            '</div>').appendTo(toolbar);
