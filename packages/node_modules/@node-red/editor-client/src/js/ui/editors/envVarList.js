                ...
                addItem: function(container, i, opt) {
                    ...
                    if (isTemplateNode) {
                        ...
                        // var copy = $.extend(true, {}, ui);
                         ...
                         $('<a href="#"><i class="fa fa-angle-right"></a>').attr('aria-label', RED._('editor.envVar.expandEdit')).prependTo(envRow).on("click", function (evt) {
                            evt.preventDefault();
                    ...
                    valueLabel: function(container,value) {
                        ...
                        if (value.length) {
                            value.forEach(function(v) {
                                if (!/^fa /.test(v.icon)) {
                                    $('<img>',{src:v.icon, alt:"", style:"max-width:14px; padding: 0 3px; margin-top:-4px; margin-left: 1px"}).appendTo(input);
                                } else {
