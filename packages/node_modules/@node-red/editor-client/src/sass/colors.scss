...
$primary-background: #f0f0f0;//#0ff;

$secondary-background: #fff;//#ff0;
$secondary-background-selected: #D9D9D9;//#e9e900;
$secondary-background-inactive: #f0f0f0;//#f0f000;
$secondary-background-hover: #e8e8e8;//#dd0;
...
// Sub label text
$tertiary-text-color: #696969;//#90f;
// Heading text
$header-text-color: #2d2d2d;//#f00;

$text-color-error: #AD1625;
$text-color-warning: #ab6400;
$text-color-success: #218358;
...
$tertiary-border-color: #cecece;//#00f;
...
$text-editor-gutter-color: #666;//#00e;
...
$event-log-color: #e4e4e4;
$event-log-active-line-background: #2a2a2a;
$event-log-selection-background: #4a4a4a;
...
$list-item-background-selected: #dbeafe;
...
$tab-hover-overlay: rgba(0,0,0,0.06);
...
$workspace-button-background-primary: #bb0000;
$workspace-button-background-primary-hover: #a21212;
...
$diff-state-added: #19704e;
$diff-state-deleted: #ce2c31;
$diff-state-changed: #9a5a00;
$diff-state-changed-background: #fff7c2;
$diff-state-unchanged: #bbb;
$diff-state-unchanged-background: #fff;

$diff-state-conflicted: #8347ac;
$diff-state-moved: #2d6a9f;
$diff-state-conflict: #9b45ce;
$diff-state-conflict-background: #ffdbdc;

$diff-state-added-background: #e6f6eb;
$diff-state-added-border: #adddc0;
$diff-state-added-header-background: #d6f1df;
$diff-state-added-header-border: #c4e8d1;

$diff-state-deleted-background: #feebec;
$diff-state-deleted-border: #fdbdbe;
$diff-state-deleted-header-background: #ffdbdc;
$diff-state-deleted-header-border: #ffcdce;
...
$link-link-active-color: #0d74ce;
$link-unknown-color: #ce2c31;

$clipboard-textarea-background: #f9f9f9;
...
$notification-border-default: #5eb1ef;
...
$debug-message-text-color-meta: #914f4f;
...
$group-default-label-color: #767676;
