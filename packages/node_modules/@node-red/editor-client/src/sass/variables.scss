...
// Heading text
    ...
    --red-ui-tab-hover-overlay: #{colors.$tab-hover-overlay};
    ...
    --red-ui-scrollbar-handle-background: #{colors.$scrollbar-handle-background};
    ...
    --red-ui-user-profile-text-color: #{colors.$user-profile-text-color};
}
